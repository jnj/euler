...
01 70 54 71 83 51 54 69 16 92 33 48 61 43 52 01 89 19 67 48"""
  ...
  def foursFrom(t: (Int, Int)) = {
    ...
    r.map {i => (t._1, t._2 + i)} ::
    r.map {i => (t._1 + i, t._2)} ::
    r.map {i => (t._1 + i, t._2 + i)} ::
    r.map {i => (t._1 + i, t._2 - i)} :: Nil
  }
  
  def valueAt(t: (Int, Int)) = grid(t._1 * w + t._2)

  def inBounds(t: (Int, Int)) = t._1 >= 0 && t._1< h && t._2 >= 0 && t._2 < w

  def positionOf(index: Int) = (index / w, index % w)
